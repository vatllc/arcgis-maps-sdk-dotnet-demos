...
namespace SceneEditingDemo
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            MySceneView.Scene = new Scene(new Basemap(new ArcGISTiledLayer(new Uri("https://services.arcgisonline.com/arcgis/rest/services/Canvas/World_Light_Gray_Base/MapServer"))));
        }
